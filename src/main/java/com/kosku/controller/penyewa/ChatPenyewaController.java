...
public class ChatPenyewaController {
    ...
    public void initialize() {
        ...
        // Fallback for demo/dev if session is null
        if (currentUser == null) {
            currentUser = userDAO.getById(User.class, 6); // penyewa_helen from seeder
        }
    ...
    private void loadContacts() {
        ...
        if (contacts.isEmpty()) {
            Label noContact = new Label("Belum ada chat dengan pemilik.");
    ...
    private HBox createContactItem(User contact) {
        ...
        String previewText = (lastMsg != null) ? lastMsg.getPesan() : "Tanya pemilik kos...";
    ...
    private void handleSendMessage() {
        ...
        messageField.clear();
        loadMessages();
        loadContacts(); // Refresh sidebar for last message preview
    }
}

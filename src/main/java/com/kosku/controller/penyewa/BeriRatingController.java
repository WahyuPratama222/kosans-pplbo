...
public class BeriRatingController implements Initializable {
    ...
    void handleKirim(ActionEvent event) {
        if (selectedBooking == null) {
            PopupManager.showError("Error", "Tidak ada data booking yang dipilih.");
            return;
        }
        ...
        try {
            ...
            PopupManager.showInfo("Sukses", "Terima kasih! Ulasan Anda berhasil disimpan.");
            ...
            e.printStackTrace();
            PopupManager.showError("Error", "Gagal menyimpan ulasan: " + e.getMessage());
        }
    }
